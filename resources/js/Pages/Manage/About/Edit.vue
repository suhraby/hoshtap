            ...
            <form @submit.prevent="onSubmit">
                ...
                <div class="mb-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        ...
                        <div v-if="about.data.image" class="mb-3">
                            <img
...
import type { About, ResourceResponse } from '@/types';
...
const props = defineProps<{
    about: ResourceResponse<About>;
}>();

const currentPageTitle = computed(() => trans('Edit about us'));

const form = useForm({
    title: Object.fromEntries(
        locales.value.map((l) => [
            l.code,
            props.about.data.title[l.code] ?? '',
        ]),
...
function onSubmit(): void {
    form.patch(route('manage.about.update', props.about.data.id), {
        preserveScroll: true,
    });
}
</script>
