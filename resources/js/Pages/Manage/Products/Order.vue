...
const currentPageTitle = wTrans('Sort products');

const sortedProducts = ref<Product[]>([...props.products.data]);
...
function onSubmit(): void {
    form.ids = sortedProducts.value.map((b) => b.id);

    form.patch(route('manage.products.sortOrder'), {
        preserveScroll: true,
    });
}
</script>
